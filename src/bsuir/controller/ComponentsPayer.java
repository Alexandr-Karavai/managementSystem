...
public class ComponentsPayer extends HBox
{
    private ObservableList<Payer> allDataU;
    private ObservableList<Payer> pageDataU  = FXCollections.observableArrayList();
    ...
    public void setTable(TablePayers table)
    {
        tablePayers = table;
        allDataU = (ObservableList<Payer>) table.getDataPayers();
    ...
    public void showPage(int pageNumber)
    {
        ...
        tablePayers.setItems(pageDataU);
