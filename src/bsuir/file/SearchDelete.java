...
//
//
//    public void start(final Stage primaryStage, final List<Organization> allData, final MenuLine parentClass)
//    {
...
//                SearchDelete.this.result = (ObservableList<Organization>) findingOne(fio, nameOfDepartment);
...
//                String nameOfDepartment = SearchDelete.this.nameOfDepartment.getText();
//                SearchDelete.this.result = (ObservableList<Organization>) findingTwo(title, nameOfDepartment);
...
//                String nameOfDepartment = SearchDelete.this.nameOfDepartment.getText();
//                SearchDelete.this.result = (ObservableList<Organization>) findingThree(faculty, nameOfDepartment);
...
//
//
//    public  List <Organization> findingOne(String fio, String nameOfDepartment)
//    {
//        List <Organization> allStudents = this.db;
//        List <Organization> result = FXCollections.observableArrayList();
//        for(int i = 0; i < allStudents.size(); i++)
//        {
//           Organization student = allStudents.get(i);
...
//
//
//    public  List <Organization> findingTwo(String title, String nameOfDepartment)
//    {
//        List <Organization> allStudents = this.db;
//        List <Organization> result = FXCollections.observableArrayList();
//        for(int i = 0; i < allStudents.size(); i++)
...
//    }
//
//    public  List <Organization> findingThree(String faculty, String nameOfDepartment)
//    {
//        List <Organization> allStudents = this.db;
//        List <Organization> result = FXCollections.observableArrayList();
//        for(int i = 0; i < allStudents.size(); i++)
